...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception{
        String localfile1 = WordCount.class.getResource("/mapReduce/WordCount.txt").getPath();
 ...
 *
 ...
 copy from: /D:/joan/workspace/idea/hadoop-family/hadoop-1.1.2/target/classes/mapReduce/WordCount.txt to hdfs://192.168.144.128:9000/user/hdfs/mapReduce
