...
/**
 * Created by hz15111811 on 2016/7/3.
...
public class SecondarySort {
    ...
    public static void main(String[] args) throws Exception{
        String localfile1 = Score.class.getResource("/mapReduce/SecondarySort.txt").getPath();
...
/**
 ...
 copy from: /D:/joan/workspace/idea/hadoop-family/hadoop-1.1.2/target/classes/mapReduce/SecondarySort.txt to hdfs://192.168.144.128:9000/user/hdfs/mapReduce
 ls: hdfs://192.168.144.128:9000/user/hdfs/mapReduce
 ==========================================================
 name: hdfs://192.168.144.128:9000/user/hdfs/mapReduce/SecondarySort.txt, folder: false, size: 28
 ==========================================================
