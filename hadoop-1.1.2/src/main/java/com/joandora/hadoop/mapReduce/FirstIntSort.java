...
public class FirstIntSort {
    ...
    public static JobConf config() {
        JobConf conf = new JobConf(FirstIntSort.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setJarByClass(FirstIntSort.class);
 ...
 *
 ...
 copy from: /D:/joan/workspace/idea/hadoop-family/hadoop-1.1.2/target/classes/mapReduce/FirstIntSort.txt to hdfs://192.168.144.128:9000/user/hdfs/mapReduce
 ls: hdfs://192.168.144.128:9000/user/hdfs/mapReduce
 ==========================================================
 name: hdfs://192.168.144.128:9000/user/hdfs/mapReduce/FirstIntSort.txt, folder: false, size: 34
 ==========================================================
