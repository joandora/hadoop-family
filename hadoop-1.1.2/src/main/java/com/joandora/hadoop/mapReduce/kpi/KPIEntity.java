...
public class KPIEntity {
    ...
    private static KPIEntity parser(String line) {
     ...
     * 按page的pv分类
     */
    public static KPIEntity filterPVs(String line) {
        KPIEntity kpi = parser(line);
     ...
     * 按page的独立ip分类
     */
    public static KPIEntity filterIPs(String line) {
        return parser(line);
    }
     ...
     * PV按浏览器分类
     */
    public static KPIEntity filterBroswer(String line) {
        return parser(line);
    }
     ...
     * PV按小时分类
     */
    public static KPIEntity filterTime(String line) {
        return parser(line);
    }
     ...
     * PV按访问域名分类
     */
    public static KPIEntity filterDomain(String line){
        return parser(line);
    }
